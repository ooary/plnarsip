...
@endsection
@section('page_header_title','Upload ADS')
@section('page_title','Upload ADS')
@section('page_child_title','Klik atau Drag and Drop ADS ')
@section('content')       
<ul class="breadcrumb">
...
<form action="{{url('arsip/ads')}}" class="dropzone" id="myDropzoneSk">
  {{csrf_field()}}
