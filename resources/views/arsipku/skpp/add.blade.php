...
@endsection
@section('page_header_title','Upload SKPP')
@section('page_title','Upload SKPP')
@section('page_child_title','Klik atau Drag and Drop SKPP ')
@section('content')       
<ul class="breadcrumb">
...
<form action="{{url('arsip/skpp')}}" class="dropzone" id="myDropzoneSk">
  {{csrf_field()}}
