...
@endsection
@section('page_header_title','Upload SIC')
@section('page_title','Upload SIC')
@section('page_child_title','Klik atau Drag and Drop SIC ')
@section('content')       
<ul class="breadcrumb">
...
<form action="{{url('arsip/sic')}}" class="dropzone" id="myDropzoneSk">
  {{csrf_field()}}
