...
@endsection
@section('page_header_title','Upload SPPD')
@section('page_title','Upload SPPD')
@section('page_child_title','Klik atau Drag and Drop SPPD ')
@section('content')       
<ul class="breadcrumb">
...
<form action="{{url('arsip/sppd')}}" class="dropzone" id="myDropzoneSk">
  {{csrf_field()}}
